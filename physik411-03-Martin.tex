...
\[
	...
	= \half e \frac{\omega}{2\piup} \oint_0^{2\piup} \dif \phi \, \ev_z
	= \half e \omega \ev_z
\]
...
\[
	\vec m = \frac{e \hbar}{4 m_\text{p}^{} r_\text{p}^2} \ev_z
\]

In der Notation der Aufgabenstelltung ist $\vec \mu_\text{p} = \vec m$.
